 ...
 */
public class GraphSQLiteReader<V> extends GraphSQLiteManager implements GraphSQLReader<V> {
     ...
     */
    public GraphSQLiteReader(String dbpath, String graphName) throws SQLException { 
        super(dbpath);
